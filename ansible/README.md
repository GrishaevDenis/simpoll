...
1) Распакуйте полученный дистрибутив simpoll и разместите в папке /var/www/simpoll на сервере
...
4) Через несколько минут сервис будет запущен. Вы можете открыть в браузере https://YOUR-DOMAIN-NAME и завершить настройку сервиса в Мастере установки.
